                ...
                <CardContent className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold text-white">{tokenStats?.totalRewards || 0}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
        ...
        return (
          <Card className="bg-slate-800/50 border-slate-700">
            <CardHeader>
              ...
              <CardDescription className="text-gray-400">
                Manage your healthcare provider relationships and permissions
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="bg-slate-700/30 p-6 rounded-lg text-center">
                ...
                <p className="text-gray-400 mb-4">
                  Connect with healthcare providers and manage consent permissions
                </p>
